...
void QVTKImageWidget::setAndDisplayImage(QString imagePath) 
{    
    ...
    this->setImageProperties(imagePath, true);
    ...
    readerFactory->CreateImageReader2(imagePath.toAscii().data());
